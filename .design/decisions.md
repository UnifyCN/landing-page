...
| D-004 | 2026-09-25 | accepted | Below 1100px the sidebar stays above the list (as in the approved B mockup), but at ≤700px the calendar folds to a "Pick a date" line and the partner list is hidden. | Independent review N-1: with the full calendar first, the first event sat 2.0 screens down at 390px and 2.7 at 320px. Folding keeps the date lens one tap away. Savar confirmed 2026-09-25. | `.design/reviews/events-2026-09-25-r1.md` N-1 | - |
...
| D-006 | 2026-09-25 | accepted | Hero stats kept as shown (35+, 450+, 18, Free); hero photo served at 800/1280/1920/2560w (AVIF + JPG) instead of the 4096px master. | Savar confirmed the stats. The master was slow to decode; phones now load 68 KB instead of 311 KB. | `scripts/build-events-hero-images.mjs` | - |
